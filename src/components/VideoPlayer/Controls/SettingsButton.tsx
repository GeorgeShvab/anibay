...
interface PropsType {
  ...
  controlsShowed: boolean
}

const SettingsButton: FC<PropsType> = ({
  handleChangeQuality,
  sources,
  muted,
  volume,
  ...
  return (
    <div className="relative" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} ref={containerRef}>
      <button
        type="button"
