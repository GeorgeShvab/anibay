...
const MainPoster: FC<Anime> = (anime) => {
  ...
  return (
    <div
      className="main-poster h-[420px] md:h-[520px] mb-6 flex flex-col justify-end p-4 md:p-10 lg:p-16 relative lg:pr-80 md:pb-32"
      style={{
    ...
    >
      <Link
        className="h-16 w-16 md:h-[80px] md:w-[80px] rounded-full flex items-center justify-center absolute bg-red opacity-90 top-40 md:top-1/2 md:translate-y-[-50%] left-1/2 translate-x-[-50%] md:translate-x-0 md:left-[unset] md:right-48 text-white block hover:bg-red-dark hover:scale-105 transition-all"
        href={`/watch/${anime.id}`}
      >
        <svg
