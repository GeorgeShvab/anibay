...
const Home: FC = async () => {
  ...
  const [popular, genres, random, latestEpisodes, popularMovies] = await Promise.all([
    popularPromise,
    genresPromise,
    randomPromise,
        ...
        <div className="z-10 relative">
          <div className="">
            ...
            <div className="lg-container">
              <Title className="px-6 mb-3 md:mb-4 !text-lg !font-semibold">Popular Movies</Title>
              <PosterGrid className="px-3 lg:px-0" data={popularMovies} />
            </div>
          </div>
        </div>
      </main>
